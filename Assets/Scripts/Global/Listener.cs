...
namespace AssemblyCSharp
{
	...
	{						
        ...
        //public delegate void OnChatReceivedHandler(ChatEvent eventObj);
        //public static event OnChatReceivedHandler OnChatReceived;

        public delegate void SendChatHandler(string _Sender, string _Message);
        public static event SendChatHandler OnSendChat;
		...
		public void onChatReceived (ChatEvent eventObj)
		{
            ...
            if (OnSendChat != null)
                OnSendChat(eventObj.getSender(), eventObj.getMessage());
